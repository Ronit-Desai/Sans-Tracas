...
class BreathCounting extends React.Component {
  constructor(props) {
    super();
      ...
      return (
        <div className="App">
          ...
          <iframe
            ...
            src="https://grassgreen.000webhostapp.com/Ronit/breathcountingtask/html/index.html"
          />
        </div>
      );
    }
  ...
  stopExpirement = () => {
    ...
    jsonBody.experiment = "breathcounting";
