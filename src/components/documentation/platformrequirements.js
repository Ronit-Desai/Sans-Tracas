    ...
    return (
      <>
        ...
        <p>
          ...
          personal/work computer, smartphone, or tablet will need to satisfy to
          use ‘Sans Tracas.’
        </p>
        ...
        <p>
          ...
          work with any other major browsers such as Safari, Mozilla Firefox, or
          Microsoft Edge (It only works with browsers supporting Web-Bluetooth).
        </p>
      </>
    );
  }
