      ...
      <>
        <div className="col-lg-10">
          ...
          <p>
            ...
            directly provide the global links unless your experiment is already
            in the ‘running’ status, that too is token restricted. Thus, the
            only option left with us is to download the experiment code from
            Pavlovia and host it on some other platform that provides web
          ...
          <div>
            <ol>
              ...
              <li>
                <p>
                  From the list of experiments, select the experiment you wish
              ...
              <li>
                <p>
                  Once it is downloaded, move the file to the desired location
                  on your computer, and unzip it. You can use any method to
                  unzip your files, such as Winrar for Windows.
                </p>
              </li>
            </ol>
            <br /> <br />
            <p>
              Now, before you begin the process of uploading your experiment
              code to GitHub for publishing the site, you will first need to add
              the library (lib) folder to your experiment folder that you just
              downloaded. As Pavlovia doesn’t provide the lib folder for
              download with the experiment source code to keep people from
              running the experiments somewhere else, you will have to download
              the lib folder from some other place. Luckily, we had already
              found the library files and uploaded them on a separate GitHub
              repository to download and add to your experiment.
            </p>
            <p>
            ...
            <p>
              Once the file is downloaded, unzip it and move the "lib" folder
              into your experiment's "master" folder or the main folder. Make
              sure that the lib folder is placed in the root folder of your
              experiment alongside other folders such as "Files", "resources",
              "images", or "html".
              <br />
