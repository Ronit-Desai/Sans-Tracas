      ...
      <>
        <div className="col-lg-10">
          ...
          <p>
            ...
            ‘GitHub Pages,’ to publish the experiment and create a global link
            for it so that it is easily accessible and can be added to the ‘Sans
            Tracas’ platform.
          </p>
          <p>
          ...
          <div>
            <ol>
              <li>
                ...
                <ol>
                  <li>
                    ...
                    pre-requisite section, and if you have not created an
                    account yet, you can create one by clicking on “sign up”
                    instead of “sign in.”
                  </li>
                  <br />
                  <li>
                  ...
                  <li>
                    <p>
                      ...
                      additional information, such as the repository's owner
                      (make sure it’s the correct account). Then, you have to
                      enter a name for your repository (choose any name, and
                      GitHub will confirm whether it’s available). You can also
                      add a short one-line description for it.
                    </p>
                    <p>
                      You will also be asked if you want to make your repository
                      ‘public’ or ‘private’; please select ‘public’ to publish
                      the experiment. Afterwards, you’ll have three other
                      options which you can check, uncheck according to your
                      preference. The first option is to add a ‘README’ file
                      explaining your repository in detail. The second one is a
                      ‘.gitignore’ file containing the list of things for git to
                      ignore (please leave both options unchecked as your
                      pavlovia experiment already has those files, if not, you
                      can create them again later). The third option is a
                      license, wherein you can choose what kind of license you
                      want for your repository; you can do that later too, so it
                      is okay to leave this one unchecked. Once everything is
                      done, press the “Create repository” button, and your new
              ...
              <p>
                ...
                <br />
                Open that file using your preferred text editor and go to the
                end of the file where you will find some lines of code similar
                to the ones displayed here.
                <br />
                ...
                uploaded to GitHub, and you won’t be able to run your
                experiment.
                <br />
              ...
              <li>
                <h5>
                  Uploading your experiment to your new GitHub repository:
                </h5>
                <p>
                  Once you’ve created a new repository, GitHub will
                  automatically open the Quick Setup page for you. On that page,
                  you will find an option for “uploading an existing file.”
                  <br />
                ...
                <p>
                  ...
                  limitations. Follow the steps below to upload using the
                  command line:
                </p>
                <ol>
                  <li>
                    ...
                    <br />
                    For Windows users, you have to open a windows command
                    prompt, while for macOS users, you have to open a terminal.
                    Now we have to enter a series of git commands, and these
                    commands are platform-independent, so they’ll remain the
                    same irrespective of the OS version.
                  </li>
                  <br />
                  <li>
                    The first thing you will need to do is change your location
                    inside the command prompt. If the location of your
                    experiment folder on your machine is in a different drive
                    than the drive you currently are in, then type the letter of
                    the drive your experiment folder is in, followed by a colon
                    and press enter. (for, e.g. if the experiment folder is in D
                    drive and the command prompt is in C drive, you enter{" "}
                    <span className="bg-dark text-white p-1 mt-5">D:</span>{" "}
                    <br />
                    ...
                    See below figure for the windows address bar which is
                    usually found on the top part of a window.
                    <br />
                  ...
                  <br />
                  <li>
                    Once you’re in the exact location in the command prompt,
                    enter{" "}
                    <span className="bg-dark text-white p-1 mt-5">
                      git init
                    </span>{" "}
                    to initialize a GitHub repository at that location. You
                    might be asked to sign in and authenticate git to access
                    your GitHub account if you’re using this for the first time
                    on your computer.
                  </li>
                  <br />
                  <li>
                ...
                <p>
                  Now, if you refresh the GitHub repository page, you will see
                  all the files there. Ensure all the folders and files from the
                  experiment folder on your local machine are present on your
                  GitHub repository. And if they are not (especially the lib
                  folder), make sure to remove the lines containing ‘lib’ from
                  the ‘.gitignore’ file and try the uploading process again.{" "}
                </p>
              </li>
              <br />
              <li>
                ...
                <ol>
                  <br />
                  <li>
                    Once inside your GitHub repository for your experiment,
                  ...
                  <li>
                    ...
                    button, which will open a dropdown menu and select the
                    “main” branch. After that, you would see another button
                    beside it. Click on it to make sure “/ (root)” is selected,
                    and then press the “Save” button beside it.
                    <br />
                ...
                <p>
                  ...
                  with a link to where your site is published on the internet.
                  If the box is in green, that means your site is successfully
                  published, and if it is blue, there is some error. Try
                  switching the source on the main branch from “/(root)” to
                  “/docs” and again back to “/(root)” to solve this error. Once
                  it is in green, click on the link to check if the experiment
                  will start. If it is stuck on a white screen with a message
                  “initializing your experiment,” that’s because the lib folder
                  was not added, so adding the lib folder will solve this issue.{" "}
                </p>
                <p>
                  Copy and save the link to this page. This link will be useful
                  to us in Step 4.
                </p>
              </li>
              <br />
