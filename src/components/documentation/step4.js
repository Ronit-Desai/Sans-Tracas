          ...
          <div>
            <ol>
              <li>
                ...
                original repository. This method allows you to edit and
                experiment your changes without affecting the original project.
                Follow the below steps to fork the ‘Sans Tracas’ repository into
                your GitHub account.
                <ol>
                  <br />
                  <li>
                  ...
                  <br />
                  <li>
                    On the right side of the top column where the repository
                    name is written, you will find a button named “Fork”,
                    alongside “Star”, and “Watch”. Click on the “Fork” button
                    and GitHub will automatically fork the repository for you
                    (i.e. create a copy of that repository in your GitHub
                    account).
                    <br />
              ...
              <br /> <br />
              <p>
                Now you have a copy of the platfom code in your account for you
                to edit the code and add your experiment to the platform. To add
                your experiment, you will need to edit 2 files in total, create
                a new js (javascript) file for your experiment and then edit the
                main platform file to add buttons for your experiment.
                <br />
                But, before you begin modifying the code, it is a good practice
                to do so by creating a new branch eventhough it’s already a
                forked repository.
                <br />
              ...
              <li>
                ...
                <ol>
                  <li>
                    In your newly created branch of your newly forked
                    repository, open the folders ‘src’-{">"}’components’-{">"}
                    ’app’.
                    <br />
                    Over here, you will see a number of files and on top where
                    the branch name is displayed beside the path you’re
                    currently in, you will find an “Add file” dropdown button.
                    Click on it and choose the “Create new file” option.
                    <br />
                  ...
                  <li>
                    ...
                    simplicity purpose, please choose the name of the file as
                    the name of your experiment and add '.js' in the end (for
                    eg, if you experiment is titled face experiment, you can
                    name the file as ‘faceexp.js’).
                    <br />
                  ...
                  <li>
                    ...
                    experiment, you can name the class as ‘FaceExp’) Please
                    ensure the first letter of each word is capitalized here.
                    <br />
                  ...
                  <li>
                    ...
                    i.e. ‘FaceExp’ as per our example. Go to the last line of
                    the file and there too, replace “XabFromPavlovia” to the
                    name of your class we used earlier i.e. ‘FaceExp’ as per our
                    example.
                    <br />
                  ...
                  <li>
                    ...
                    44, 101, 110, 123, 130), and on all those instances, replace
                    ...
                    are already capitalized (lines 44, 110), and whereever they
                  ...
                  <li>
                    ...
                    Go to line 78 of the code and for the src variable replace
                    the existing link inside the double quotations with that
                    saved link of your experiment hosted on GitHub. Be careful
                    to not delete the doublt quotations.
                    <br />
                  ...
                  <br />
                  <li>
                    Scroll to the bottom of the page to find the “Commit new
                    file” section. Enter a commit message there (which is
                    usually to make the owner understand what changes you made,
                    so you can add something like ‘created new js file for Face
                    experiment’). Leave the radio buttons unchanged and click on
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    ...
                    files, click on the “main.js” file. Once opened, you will
                    see a title bar, detailing the number of lines in the code.
                    On the right side, you will find the Edit button that is
                    shaped like a pencil beside the delete button that is shaped
                    like a trash can. Click the edit button to start editing the
                    main.js file.
                    <br />
              ...
              <li>
                <h5>
                  Creating a Pull request to merge your changes with the
                  original code:
                </h5>
                <ol>
                  <br />
                  ...
                  <br />
                  <li>
                    On the comparing changes screen, you will be shown a base
                    and head repository. The base repository should be the
                    original repository, and the head repository should be your
                    forked repository. Ensure that this is in place. Also,
                    ensure that with the head repository, the “compare” field
                    has your new branch as the selected branch. Only then will
                    you be able to compare your changes, otherwise it’ll display
                    the message, “There isn’t anything to compare.”
                    <br />
                  ...
                  <li>
                    ...
                    “Create pull request” button inside a blue box. Click on
                    that button to create your pull request.
                    <br />
            ...
            <p>
              ...
              repository and merged with the original code if he finds the
              changes to be appropriate.
            </p>
            <p>
              Thus ends your part in the integration process. Once you create a
              pull request, your job is done and then it is up to me to review
              and merge the changes together. I will contact you via GitHub as
              well as the email you’ll provide us if there are any changes you
              would need to make or solve any issues.
            </p>
            <p>
